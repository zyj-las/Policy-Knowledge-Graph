...
# 记录训练过程
log_file_path = 'modles/PDistilBert_goal.txt'
# log_file_path = 'modles/PDistilBert_measure.txt'
# log_file_path = 'modles/PDistilBert_instrument.txt'
# log_file_path = 'modles/PDistilBert_actbe.txt'
...
# 保存图像
plt.savefig('outputs/PDistilBert_goal.png')
# plt.savefig('modles/PDistilBert_measure.png')
# plt.savefig('modles/PDistilBert_intrument.png')
# plt.savefig('modles/PDistilBert_actbe.png')
#plt.show()
print(f"曲线图已保存")
