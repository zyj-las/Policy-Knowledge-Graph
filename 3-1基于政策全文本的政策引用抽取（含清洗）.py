...
# 设置文件夹路径和输出文件路径
folder_path = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\科研诚信政策-国家-文本分析-20240912'
output_file = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策引用-新.csv'
policy_id_file = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\国家科研诚信政策-0912.xlsx'
