import pandas as pd
# 读取数据
policy_citation_df = pd.read_csv(r"D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策引用.csv", encoding='utf-8-sig')
policy_publish_df = pd.read_csv(r"D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策发布.csv", encoding='utf-8-sig')
policy_body_df = pd.read_csv(r"D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策主体.csv", encoding='utf-8-sig')
...
# 将【政策主体】与【主体类型】对应
merged_df = pd.merge(lead_publish_df, policy_body_df, on='政策主体ID', how='left')
...
# 将结果保存到新文件
policy_citation_df.to_csv(r"D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策引用-类型.csv", index=False, encoding='utf-8-sig')
