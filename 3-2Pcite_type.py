import pandas as pd
policy_citation_df = pd.read_csv(r"D:\cite.csv", encoding='utf-8-sig')
policy_publish_df = pd.read_csv(r"D:\release.csv", encoding='utf-8-sig')
policy_org_df = pd.read_csv(r"D:\org.csv", encoding='utf-8-sig')
...
# 将结果保存到新文件
policy_citation_df.to_csv(r"D:\cite_type.csv", index=False, encoding='utf-8-sig')