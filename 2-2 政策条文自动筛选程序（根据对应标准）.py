...
import re
# 读取Excel文件
policy_file_path = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\国家科研诚信政策-0912.xlsx'
split_file_path = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0912\政策分段-新.xlsx'
...
# 将筛选结果保存到新的Excel文件
result_df.to_excel(r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0912\政策段落-新3.xlsx', index=False)
