...
# 记录文件路径
log_file_path = 'D:\\Experiment_zyj\\Python_exp\\policy_map\\actbe_bert_迭代过程.txt'
...
# 保存图像
plt.savefig('D:\\Experiment_zyj\\Python_exp\\policy_map\\actbe_bert_曲线图.png')
#plt.show()
print(f"曲线图已保存")

# 保存模型权重
model_save_path = 'D:\\Experiment_zyj\\Python_exp\\policy_map\\actbe_bert_model.pth'
