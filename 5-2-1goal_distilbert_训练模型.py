...
# 记录文件路径
log_file_path = 'D:\\Experiment_zyj\\Python_exp\\policy_map\\goal_distilbert_迭代过程2.txt'
...
bestmodel_save_path = 'D:\\Experiment_zyj\\Python_exp\\policy_map\\goal_distilbert_model_best.pth'  # 最佳模型保存路径
'''
# 训练和验证循环
...
# 保存图像
plt.savefig('D:\\Experiment_zyj\\Python_exp\\policy_map\\goal_distilbert_曲线图2.png')
#plt.show()
print(f"曲线图已保存")

# 保存最终模型权重
model_save_path = 'D:\\Experiment_zyj\\Python_exp\\policy_map\\goal_distilbert_model2.pth'
