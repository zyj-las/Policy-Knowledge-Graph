...
# 读取Excel文件和CSV文件
excel_file = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\国家科研诚信政策-0912.xlsx'
csv_file = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策主体.csv'
output_file = r'D:\File_zyj\2.论文文件\4.小论文_政策知识图谱\数据分析文件0929\政策发布-新.csv'
