...
# 记录训练过程
log_file_path = 'modles/PBert_goal.txt'
# log_file_path = 'modles/PBert_measure.txt'
# log_file_path = 'modles/PBert_instrument.txt'
# log_file_path = 'modles/PBert_actbe.txt'
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('modles/PBert_goal.png')
# plt.savefig('modles/PBert_measure.png')
# plt.savefig('modles/PBert_intrument.png')
# plt.savefig('modles/PBert_actbe.png')
#plt.show()
#print(f"曲线图已保存")

# 保存模型
model_save_path = 'modles/PBert_goal.pth'
# model_save_path = 'modles/PBert_measure.pth'
# model_save_path = 'modles/PBert_instrument.pth'
# model_save_path = 'modles/PBert_actbe.pth'
torch.save({
